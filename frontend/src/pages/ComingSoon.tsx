...
export default function ComingSoon() {
  ...
  return (
    <>
      <PageMeta
        title="IntroHub | Coming Soon"
        description="Our website is currently under construction. Enter your email to get the latest updates and notifications about the website."
      />
